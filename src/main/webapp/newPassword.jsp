...
<body oncontextmenu='return false' class='snippet-body bg-info'>
			...
			<div class="row justify-content-center">
				<div class="col-12 col-md-9 col-lg-7 col-xl-6 mt-5">
					...
					<div class="container bg-white rounded mt-2 mb-2 px-0">
						...
						<div class="pt-3 pb-3">
							<form class="form-horizontal" action="newPassword" method="POST" id="formsubmit">
								<!-- User Name Input -->
								...
								<div class="form-group row justify-content-center px-3">
									<div class="col-9 px-0">
										<input type="text" name="password" placeholder="&#xf084; &nbsp; New Password" id="password"
											class="form-control border-info placeicon">
									</div>
								</div>
								<!-- Password Input -->
	...
	<script type='text/javascript' src='https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.bundle.min.js'>
	 ...
	 <script type='text/javascript'>
	     ...
	     const conPassword=document.getElementById("confPassword");
